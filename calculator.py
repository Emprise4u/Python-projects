...
entry1 = Entry(window, width=50, borderwidth=10, bg="light blue")
entry1.grid(row=0, column=0, columnspan=4, padx=10, pady=10)

def addButton(num):
    return Button(window, padx=16, pady=8, fg="blue",text=num, width=5, command=lambda:clickButton(str(num)))
